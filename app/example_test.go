...
func Example() {
	dir, err := os.MkdirTemp("", "dqlite-app-example-")
	if err != nil {
		return
	}
...
func ExampleWithCluster() {
	dir1, err := os.MkdirTemp("", "dqlite-app-example-")
	if err != nil {
		return
	}
	defer os.RemoveAll(dir1)

	dir2, err := os.MkdirTemp("", "dqlite-app-example-")
	if err != nil {
		return
	}
	defer os.RemoveAll(dir2)

	dir3, err := os.MkdirTemp("", "dqlite-app-example-")
	if err != nil {
		return
	}
