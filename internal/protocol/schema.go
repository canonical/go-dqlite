...
//go:generate ./schema.sh --request Prepare:1  db:uint64 sql:string
...
//go:generate ./schema.sh --response StmtWithOffset db:uint32 id:uint32 params:uint64 offset:uint64
